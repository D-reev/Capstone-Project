...
import { Menu, CheckCircle, XCircle, Clock, Bell, MessageSquare } from 'lucide-react';
...
export default function AdminRequests() {
  ...
  // transaction-safe approve (decrement inventory + update request)
  const handleStatusUpdate = async (requestId, newStatus) => {
    try {
      ...
      if (newStatus === 'approved') {
        // run a transaction to ensure inventory consistency
        await runTransaction(db, async (tx) => {
          ...
          // collect part refs and current stocks
        ...
        // after successful transaction, create sanitized log
        ...
        // For other statuses, just update (e.g., completed)
            ...
            <table className="requests-table">
              ...
              <tbody>
                ...
                {displayedRequests.length === 0 && (
                  <tr><td colSpan={7} style={{ textAlign: 'center', padding: '1rem' }}>No requests</td></tr>
                )}
              </tbody>
            </table>
          </div>
